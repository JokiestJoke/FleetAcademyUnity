...
public class DialogueSystem : MonoBehaviour
{
    ...
    private void checkDialogue(Dialogue[] dialogues){
        int dialogueCount = 0;
        foreach(Dialogue dialogue in dialogues){
            Debug.Log("Dialogue: \n ---------------------");
            Debug.Log("Character name: " + dialogue.characterName + "\n");
            Debug.Log("Character Message: " + dialogue.message + "\n");
            Debug.Log("---------------------");
            dialogueCount++;
        }
        Debug.Log("Dialogues in array : " + dialogueCount);
    }
